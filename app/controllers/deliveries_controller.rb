class DeliveriesController < ApplicationController
  ...
  def index
    ...
    @orders = @orders.select("clients.phone_number, clients.address, GROUP_CONCAT(distinct products.name separator ', ') as pr_name, count(order_details.status)  as pr_count")
  end
end
